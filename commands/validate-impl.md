...
> Terminology: **ceiling**, **effective-set**, **spec-union** — see `CLAUDE.md` "Configurable Workflow → Key terms" glossary. "spec-union" is reserved for Step 2 over-all-tasks union.
