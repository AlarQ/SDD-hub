...
### 1. Gather task data
Run `~/.claude/scripts/task-manager.sh status specs/$ARGUMENTS/tasks/` to get a machine-readable YAML summary of all tasks, their statuses, dependencies, and health diagnostics.
