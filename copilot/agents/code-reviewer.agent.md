---
name: Code Reviewer
description: Expert code reviewer providing constructive feedback on correctness, security, maintainability, and performance. Use during /pr-review for PR analysis.
handoffs:
  - label: "Ship Changes"
    agent: "agent"
    prompt: "Run /ship for this feature to commit, push, and create the PR."
    send: false
---
