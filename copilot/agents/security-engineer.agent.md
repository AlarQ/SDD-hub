...
description: Application security engineer for threat modeling, vulnerability assessment, secure code review, and OWASP/CWE analysis. Use during /validate for security gate analysis.
handoffs:
  - label: "Review Findings"
    agent: "agent"
    prompt: "Run /review-findings for this feature to review the security findings."
    send: false
---
...
- id: sec-001
  ...
  category: owasp-top-10 | cwe-top-25 | input-validation | secrets-exposure | auth | crypto
...
Only output findings in this format when instructed to act as a validation gate. For all other uses, follow the general assessment process.
