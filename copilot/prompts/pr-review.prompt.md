...
2. Identify the task: extract task ID from the current branch name (`feat/<feature>/{task-id}-{task-name}`) and read the matching task file from `specs/<feature>/tasks/`
