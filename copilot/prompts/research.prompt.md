---
name: research
description: Activate anti-hallucination research mode with citation discipline
agent: 'ask'
---
...
- **External sources** — use web search, provide the URL
...
- **Does not slow you down** — search efficiently
