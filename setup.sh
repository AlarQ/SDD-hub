...
echo -e "  4. Follow the workflow: ${CYAN}/explore${RESET} -> ${CYAN}/propose${RESET} -> ${CYAN}/implement${RESET} -> ${CYAN}/validate${RESET} -> ${CYAN}/review-and-ship${RESET} -> ${CYAN}/learn-from-reports${RESET}"
